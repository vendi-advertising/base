...
class DataCriteria extends MultipleElementCriteria
{
    ...
    {
        $this->data_encode[0] = CleanVariable($this->data_encode[0], '', ['hex', 'ascii']);
        $this->data_encode[1] = CleanVariable($this->data_encode[1], '', ['hex', 'ascii']);
        ...
        $this->criteria[$i][4] = CleanVariable($curArr[4], '', ['AND', 'OR']);
        // Destroy the copy
        unset($curArr);
    }
